...
, hogy a PurePos rendszer egy megfelelő morfológiai elemzővel kiegészülve adekvát alapja egy automatikus morfémaszám-becslő eljárásnak. %, és így kiváltja a fáradtságos emberi munkát. 
...
Az  lánc pontosságának méréséhez létrehoztunk egy 1000 megnyilatkozásból álló etalon adathalmazt, melyek a MONYEK \cite{Matyus2014} korpusz részét képezik. 
...
A módszer alapját egy szabály-alapú szegmentáló algoritmus képezi, amit felügyelet nélküli gépi tanulással egészítettem ki. %, melyek hatékonyan képesek javítani a teljesítményén.
