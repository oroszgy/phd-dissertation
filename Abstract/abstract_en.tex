...
The first part of this study describes morphological tagging algorithms which can compute both the morphosyntactic tags and lemmata of words accurately. 
...
Next, an application of the presented tagger is described aims to produce morphological annotation for speech transcripts, and thus, the first morphological disambiguation tool for spoken Hungarian is introduced.
