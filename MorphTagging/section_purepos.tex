...
Secondly, we assembled full morphological taggers from available components, since two-phase architectures were also shown to be prosperous (e.g.~\cite{Agic2013,Erjavec2004}). 
