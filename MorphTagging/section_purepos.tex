...
This study introduces a new morphological tagging method built on simple trigram-based \gls{pos} tagging algorithms using a pluggable morphological analyzer component.
