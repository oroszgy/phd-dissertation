...
Further on, we show an \acrshort{mlum} estimation method based on the tool resulting in high correlation with the result of human annotators. 
...
This study introduce adaptation methods for a general-purpose tagger tool that is then utilized for counting morphemes resulting in accurate \acrshort{mlum} estimates.
...
Beside this, both the gold standard data and the output of the enhanced tagging tool were also used as an input for the estimator. %enabling a detailed comparison of enhancements presented. 
