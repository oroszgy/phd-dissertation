...
I start summarizing my results by describing the new lemmatization method followed by the full tagging systems. 
...
Moving on, I also compared existing tagging systems with mine on a less-resourced scenario.
...
Therefore, my investigation showed the PurePos is an appropriate base for tagging corpora of transcribed spoken texts.
...
I proposed a new algorithm for estimating morphosyntactic complexity (calculating \acrlong{mlum}) in Hungarian child language transcripts.
...
On the contrary, my method can detect both token and sentence boundaries accurately, producing F-values over 90\%.
